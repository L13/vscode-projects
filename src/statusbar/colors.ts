...
export const colors:StatusbarColors[] = [
	...
	{ // purple
		'statusBar.background': '#691d7c',
		'statusBar.foreground': '#ffffff',
		'statusBarItem.hoverBackground': '#7a3c8a',
	},
	{ // blue
		'statusBar.background': '#0178cf',
		'statusBar.foreground': '#ffffff',
		'statusBarItem.hoverBackground': '#1f8ad2',
	},
	{ // green
